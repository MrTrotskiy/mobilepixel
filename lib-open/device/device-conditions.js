...
exports.DeviceConditions = void 0;
...
class DeviceConditions {
     ...
     */
    async setAirplaneMode(deviceId, enable) {
        try {
     ...
     * @param enable - True to enable, false to disable
     */
    async setMobileData(deviceId, enable) {
        try {
            const command = enable ? "enable" : "disable";
            (0, child_process_1.execFileSync)("adb", [
                "-s",
     ...
     */
    async setNetworkCondition(deviceId, condition) {
        switch (condition) {
            case "offline":
     ...
     */
    async setGeolocation(deviceId, latitude, longitude) {
        try {
     ...
     */
    async getBatteryStatus(deviceId) {
        try {
            const output = (0, child_process_1.execFileSync)("adb", [
                "-s",
                deviceId,
                "shell",
                "dumpsys",
...
exports.DeviceConditions = DeviceConditions;
