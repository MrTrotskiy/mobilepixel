...
const session_manager_1 = require("../pro/device/session-manager");
...
class WebDriverAgent {
    ...
    constructor(host, port) {
        this.host = host;
        this.port = port;
        this.sessionManager = new session_manager_1.SessionManager(host, port);
                ...
                actions: [
                    {
                        ...
                        actions: [
                            ...
                            { type: "pointerDown", button: 0 },
                            { type: "pointerMove", duration: config_1.DURATIONS.swipe, x: x1, y: y1 },
                            { type: "pointerUp", button: 0 }
                        ]
                    }
                ]
